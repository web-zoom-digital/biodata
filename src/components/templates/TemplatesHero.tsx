...
export function TemplatesHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-amber-50/90 via-orange-50/80 to-rose-100/90 py-12 sm:py-20 lg:py-24">
      <JsonLd data={breadcrumbJsonLd(trail)} />

      {/* Background Image */}
      <Image
        src="/images/heroes/templates-hero-bg.jpg"
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col items-start text-left lg:col-span-6">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-700 sm:text-lg">
              Browse our collection of traditional, modern, minimal and floral marriage biodata formats. Pick any template to customize with live preview and instant download.
            </p>
          ...
          <div className="relative flex items-center justify-center lg:col-span-6">
            ...
            <div className="absolute -top-10 left-8 z-20 hidden sm:flex items-center gap-2 text-amber-800 font-semibold text-sm">
              <div className="flex flex-col items-center">
                <span className="font-handwriting text-base font-bold italic tracking-wide text-amber-700 drop-shadow-sm">
                  Professional Templates
                </span>
                <svg className="size-10 text-amber-600 -rotate-12" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
