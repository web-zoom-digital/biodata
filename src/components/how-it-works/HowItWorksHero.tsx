...
export function HowItWorksHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50/90 via-teal-50/80 to-green-100/90 py-12 sm:py-20 lg:py-24">
      {/* Background Image with High Visibility */}
      <Image
        src="/images/heroes/how-it-works-hero-bg.jpg"
        alt="How It Works Marriage Biodata Maker"
        fill
        priority
        sizes="100vw"
      ...
      <div className="pointer-events-none absolute -top-40 -left-40 size-[36rem] rounded-full bg-emerald-300/40 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute top-1/2 -right-20 size-[32rem] rounded-full bg-teal-300/35 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute -bottom-32 left-1/3 size-[30rem] rounded-full bg-green-200/40 blur-3xl" aria-hidden="true" />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col items-start text-left lg:col-span-6">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-700 sm:text-lg">
              From an empty form to a print-ready PDF or high-resolution image in about ten minutes. Everything happens right inside your browser with complete privacy.
            </p>
            ...
            <ul className="mt-10 grid grid-cols-1 gap-3 text-sm font-semibold text-slate-700 sm:grid-cols-2">
              {[
                ...
                "Your details stay in browser",
                "Instant PDF, PNG & JPEG download",
                "Live real-time A4 page preview",
              ].map((text) => (
                <li key={text} className="flex items-center gap-2.5">
                  <div className="flex size-5 items-center justify-center rounded-full bg-emerald-600 text-white shadow-sm">
          ...
          <div className="relative flex items-center justify-center lg:col-span-6">
            ...
            <div className="absolute -top-10 left-8 z-20 hidden sm:flex items-center gap-2 text-emerald-800 font-semibold text-sm">
              <div className="flex flex-col items-center">
                <span className="font-handwriting text-base font-bold italic tracking-wide text-emerald-700 drop-shadow-sm">
                  Live A4 Preview
                </span>
                <svg className="size-10 text-emerald-600 -rotate-12" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
            ...
            <div className="relative min-h-[30rem] w-full max-w-[34rem] py-6">
              ...
              {templateCenter ? (
                <div className="relative mx-auto z-20 w-[62%] -rotate-[2deg] rounded-2xl bg-white p-2.5 shadow-[0_25px_60px_-15px_rgba(5,150,105,0.35)] border-2 border-emerald-400/40 transition-transform duration-500 hover:scale-105 hover:rotate-0">
